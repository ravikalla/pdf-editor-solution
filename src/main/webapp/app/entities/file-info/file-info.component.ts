...
export class FileInfoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.fileInfoService
      ...
      .subscribe(
        (res: HttpResponse<IFileInfo[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInFileInfos(): void {
    this.eventSubscriber = this.eventManager.subscribe('fileInfoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFileInfo[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.router.navigate(['/file-info'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
