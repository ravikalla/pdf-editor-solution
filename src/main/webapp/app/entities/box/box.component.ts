...
export class BoxComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.boxService
      ...
      .subscribe(
        (res: HttpResponse<IBox[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IBox): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInBoxes(): void {
    this.eventSubscriber = this.eventManager.subscribe('boxListModification', () => this.loadPage());
  }

  delete(box: IBox): void {
  ...
  protected onSuccess(data: IBox[] | null, headers: HttpHeaders, page: number): void {
