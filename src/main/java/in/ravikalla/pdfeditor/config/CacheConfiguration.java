package in.ravikalla.pdfeditor.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, in.ravikalla.pdfeditor.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, in.ravikalla.pdfeditor.repository.UserRepository.USERS_BY_EMAIL_CACHE);
